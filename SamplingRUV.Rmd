...
Data and script to replicate analyses in Hsu et al. (2024). If used in full or in part, please cite the original publication: 

Hsu TH.T, Gordon S, Rerrari R, Hoey A.S, Figueira W.F (2024) Optimizing remote underwater video sampling to quantify relative abundance, richness, and corallivory rates of reef fish. doi:  []()

Raw data also available on [Sydney eScholarship](link) and [AIMS Metadata Repository](link)
